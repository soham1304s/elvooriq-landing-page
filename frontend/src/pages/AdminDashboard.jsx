...
const AdminDashboard = () => {
  ...
  const renderSidebar = () => (
    <aside className="admin-sidebar">
      <div className="sidebar-brand" style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '1.25rem 1.5rem' }}>
        <img src={logoImg} alt="ELVOORIQ" style={{ height: '38px', width: 'auto', objectFit: 'contain' }} />
        <span style={{ fontSize: '0.72rem', fontWeight: 800, color: '#fbbf24', letterSpacing: '1px', background: 'rgba(251, 191, 36, 0.1)', padding: '2px 6px', borderRadius: '4px', border: '1px solid rgba(251, 191, 36, 0.25)' }}>ADMIN</span>
      </div>
      ...
      <div className="admin-card">
        ...
        <form onSubmit={handleAddTalent} className="creator-add-form">
          <div className="input-row">
            <div className="input-group">
              <label>Name</label>
              <input type="text" name="name" value={talentForm.name} onChange={handleTalentFormChange} placeholder="e.g. Aishwarya Harishankar" required />
            </div>
            <div className="input-group">
              <label>Handle</label>
              <input type="text" name="handle" value={talentForm.handle} onChange={handleTalentFormChange} placeholder="e.g. @aishwaryaharishankar" required />
            </div>
          </div>
          <div className="input-row">
            <div className="input-group">
