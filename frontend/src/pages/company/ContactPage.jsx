    ...
    <PageLayout>
      ...
      <div className="container page-content-section">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '36px' }}>
          ...
          {/* Left Column: Headquarters, Channels & Interactive Map */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div className="glass-card">
              ...
              <div style={{ display: 'flex', gap: '16px', marginBottom: '20px' }}>
                <div className="card-icon" style={{ width: '44px', height: '44px', marginBottom: 0, color: '#E5C158' }}><MapPin size={20} /></div>
                <div>
              ...
              {/* High-Contrast Interactive Map Widget */}
              <div className="map-widget" style={{ marginTop: '24px' }}>
            ...
            {/* Instant WhatsApp Priority Connect Card */}
            <a 
