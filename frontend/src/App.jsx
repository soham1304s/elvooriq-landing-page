...
import EmployeeWorkspacePortal from './pages/EmployeeWorkspacePortal';
    ...
    <ThemeProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/login-classic" element={<SplitLogin />} />
          <Route path="/register" element={<SplitRegister />} />
          <Route path="/onboard/:userId" element={<CandidateOnboardingPortal />} />
          
          {/* Enterprise Multi-Role Gateways */}
          ...
          <Route path="/workspace-portal" element={
            <RoleRoute allowedRoles={['ADMIN', 'EMPLOYEE']}>
              <EmployeeWorkspacePortal />
            </RoleRoute>
          } />
